											...
											<p class="text-muted">1. معلومات الطلب</p>
												...
												<div class="col-lg-4"></div>
												 <?php if(!isset($trusted_cust)||($trusted_cust==0)):?>
													<div class="col-lg-4"> 
													<button class="btn btn-block btn-info btn-xs" onclick='trust_him(<?php echo $record[0]->cid?>)'>إضافة إلى زبائن المطعم</button> 
													</div>
													<div class="col-lg-4">	
												...
												<?php else:?>	
													<div class="col-lg-4"> 
													<button class="btn btn-warning btn-info btn-xs" onclick='untrust_him(<?php echo $record[0]->cid?>)'>حذف من قائمة الزبائن</button> 
													</div>
													<div class="col-lg-4">	
