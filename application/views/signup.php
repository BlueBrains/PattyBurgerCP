	  ...
	  <hr>
        <form action="<?php echo base_url()?>auth/signup" method="POST">
			<div class="page active">
			  ...
			  <div class="page">
			  <p class="text-aqua">3. بيانات المطعم</p>
				  <div class="form-group has-feedback">
					<input type="text" class="form-control" name="res_name" placeholder="اسم المطعم"/>
				  ...
				  <div class="form-group has-feedback">
					<input type="text" class="form-control" name="phone1"  placeholder="رقم الهاتف الأساسي"/>
					<span class="glyphicon glyphicon-phone-alt form-control-feedback"></span>
				  </div>
				  <div class="form-group has-feedback">
					<input type="text" class="form-control" name="min"  placeholder="الحد الأدنى من الأسعار"/>
					<span class="glyphicon glyphicon-stats form-control-feedback"></span>
				  </div>
			  </div>
			   <div class="page">
			   <p class="text-green">4. انتهينا !</p>
				  <div class="form-group has-feedback">
				 ...
				 <div class="form-group">
				   ...
				   <div class="row">
						<div class="col-xs-4">
							<input type="submit" class="btn btn-primary btn-block btn-flat" value="إضافة المطعم" id="last_sub">
						</div>
					</div>	
			  </div>
			</form>
		...
		<form action="<?php echo base_url()?>auth/login" method="GET">
				<input type="submit" class="btn btn-block btn-success btn-lg" value="لديك حساب مسبقا ! سجل دخولك الآن">
		</form>		
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
